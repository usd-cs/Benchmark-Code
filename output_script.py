...
def train_model(buoy):
    ...
    return lr_w_int_preds_df, rf_preds_df
...
linear_df, random_forest_df = train_model(buoy_interpolated)
...
# only display data from 4 fold
linear_df = filter_fold(linear_df, 4)

display_results(linear_df)
